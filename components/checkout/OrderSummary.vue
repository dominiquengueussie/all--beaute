    ...
    <div class="bg-white rounded-xl shadow-md p-6 sticky top-24">
        ...
        <div class="space-y-2 text-sm mb-6">
            ...
            <div class="pt-2 mt-2 border-t border-gray-200 flex justify-between">
                ...
                <span class="text-base font-bold text-slate-600">{{
                    ...
                    Number(shippingCost.replace(/[^0-9.-]+/g, ""))
                }}
                    Fcfa</span>
            </div>
        </div>
        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row gap-2 sm:gap-0">
                ...
                />
                <button class="w-full sm:w-auto bg-slate-600 hover:bg-slate-700 text-white px-6 py-2 rounded-lg sm:rounded-l-none sm:rounded-r-lg whitespace-nowrap transition-colors duration-200">
                    Appliquer
                </button>
            </div>
        </div>
        ...
        <button @click="confirmOrder"
            class="w-full bg-slate-600 hover:bg-slate-700 text-white py-3 rounded-button font-medium text-base whitespace-nowrap cursor-pointer transition-colors duration-200">
