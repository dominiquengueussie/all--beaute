...
<template>
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label for="postalCode" class="block text-sm font-medium text-gray-700 mb-1">Code postal (optionnel)</label>
                <input type="text" id="postalCode" v-model="shippingInfo.postalCode"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500"
                    placeholder="75001" />
            </div>
            <div>
            ...
            <div class="md:col-span-2">
                <label for="notes" class="block text-sm font-medium text-gray-700 mb-1">Notes de livraison
                    (optionnel)</label>
