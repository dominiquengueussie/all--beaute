    ...
    <div>
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            <div class="bg-slate-600 px-6 py-4">
                <h3 class="text-xl font-semibold text-white">Récapitulatif des Services</h3>
            </div>
            <div class="p-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-semibold text-sm text-slate-600">{{ service.price }} Fcfa</span>
                                </div>
                                <div class="flex justify-between mt-1">
                                    ...
                                    <span v-if="selectedTimes[index]" class="text-sm text-gray-800">
                                        <i class="far fa-calendar-check mr-1"></i> {{ formatSelectedDate(selectedDate)
                                        }} à {{ selectedTimes[index] }}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="border-t border-gray-200 pt-4 mt-4">
                    <div class="flex justify-between font-medium text-gray-800">
                        <span>Total</span>
                        <span class="font-bold text-slate-600">{{ serviceTotalPrice }} Fcfa</span>
                    </div>
                </div>
            </div>
            <!-- Promo Code -->
            <div class="mb-4 mx-2 mt-6">
                <div class="flex">
                    <input type="text" v-model="promoCode" placeholder="Code promo"
            ...
            <div class="mb-6 text-center">
              <div class="flex justify-center space-x-3 mb-2">
                ...
                <span><img src="/img/orange.png" alt="paiement orange" class="w-8"></span>
                <span><img src="/img/mtn.png" alt="paiement mtn mobile money" class="w-9"></span>
              </div>
                ...
                <form @submit.prevent="$emit('submit')">
                    ...
                    <div class="mb-6">
                        <label class="flex items-start">
                            <input type="checkbox" v-model="contactInfo.marketing"
                                class="mt-1 h-4 w-4 text-slate-900 focus:ring-slate-900 border-gray-300 rounded" />
                            <span class="ml-2 text-sm text-gray-600">
                                Je souhaite recevoir des offres promotionnelles et des
