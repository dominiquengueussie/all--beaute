            ...
            <header class="bg-white shadow-sm py-4 px-6 flex items-center justify-between sticky top-0 z-5">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3 cursor-pointer">
                        ...
                        <div>
                            <p class="font-medium text-sm">Sophie Dubois</p>
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        <div class="md:w-1/3 flex flex-col items-center">
                            <div class="relative mb-4">
                                <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-pink-100">
                                    <img :src="userAvatar" alt="Photo de profil" class="w-full h-full object-cover" />
                                </div>
                                <button
                                    class="absolute bottom-0 right-0 bg-pink-600 text-white p-2 rounded-full shadow-md hover:bg-pink-700 transition-colors duration-200 cursor-pointer !rounded-button whitespace-nowrap">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div v-for="(day, index) in professionalInfo.openingHours" :key="index"
                                    ...
                                    <div class="w-2/3 flex items-center space-x-2">
                                        <select v-model="day.status"
                                            class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-300 text-sm">
                                            <option value="open">Ouvert</option>
                                            <option value="closed">Fermé</option>
                                        </select>
                                        <div v-if="day.status === 'open'" class="flex items-center space-x-2">
                                            <input type="time" v-model="day.openTime"
                                                class="px-2 py-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-300 text-sm" />
                                            <span>-</span>
...
const personalInfo = ref({
    ...
    bio: "Esthéticienne passionnée avec plus de 10 ans d'expérience dans les soins du visage et du corps. Spécialisée dans les techniques de massage relaxant et les soins anti-âge.",
});

// Professional Information
const professionalInfo = ref({
    businessName: "Beauté Zen",
    address: "15 rue des Fleurs, 75008 Paris",
    businessPhone: "01 23 45 67 89",
    businessEmail: "contact@beautezen.fr",
    website: "https://www.beautezen.fr",
